        ...
        val selectableDates: SelectableDates = remember(minDateUtcMillis, maxDateUtcMillis) {
            object : SelectableDates {
                ...
                override fun isSelectableYear(year: Int): Boolean {
                    ...
                    val okMin = minDateUtcMillis?.let { cal.timeInMillis = it; year >= cal.get(Calendar.YEAR) } ?: true
                    val okMax = maxDateUtcMillis?.let { cal.timeInMillis = it; year <= cal.get(Calendar.YEAR) } ?: true
                    return okMin && okMax
                }
            }
        }
