...
import com.app.arcabyolimpo.presentation.screens.beneficiary.ModifyBeneficiaryViewModel
            ...
            Column(
                ...
                if (isLoading) {
                    ...
                    SelectInput(
                        ...
                        selectedOption =
                            disabilities
                                .firstOrNull { it.name == formData.discapacidad || it.id == formData.discapacidad }
                                ?.let { it.name }
                                ?: "Seleccionar discapacidad",
                        options = disabilities.map { it.name },
                        onOptionSelected = { selectedText ->
                            val selectedDisability = disabilities.find { it.name == selectedText }

                            viewModel.updateFormData {
                                copy( discapacidad = selectedDisability?.id ?: "" )
                            }
                        },
