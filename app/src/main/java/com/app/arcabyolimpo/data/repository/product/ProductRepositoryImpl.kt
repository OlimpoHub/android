...
class ProductRepositoryImpl
    ...
    constructor(
         ...
         */
        override suspend fun searchProducts(query: String): List<Product> = api.searchProducts(query).map { it.toDomain() }
         ...
         */
        override fun getProductById(productId: String): Flow<com.app.arcabyolimpo.domain.common.Result<Product>> =
            flow {
